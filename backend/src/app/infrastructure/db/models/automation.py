...
class AutomationConfigModel(Base):
    ...
    auto_add_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    auto_add_trigger_atr_multiple: Mapped[float] = mapped_column(Float, nullable=False, default=1.0)
    auto_add_tranche_margin_pct: Mapped[float] = mapped_column(Float, nullable=False, default=0.80)
    auto_add_max_tranches: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    auto_add_protected_stop_roe: Mapped[float] = mapped_column(Float, nullable=False, default=0.002)
